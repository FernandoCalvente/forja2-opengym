...
export default function Home() {
  ...
  return <div className="narrow">
    <div className="hdr">
      <div><h1>{user ? t('Hi {0}', user.name) : 'Forja'}</h1><div className="sub">{today.toLocaleDateString(dateLocale(), { weekday: 'long', day: 'numeric', month: 'long' })}</div></div>
      {user && <button className="iconbtn" onClick={() => nav('/forja')} aria-label="Forja"><Icon name="trophy" /></button>}
